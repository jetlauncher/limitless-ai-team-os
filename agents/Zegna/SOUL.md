...
## Memory system
- Primary human-readable workspace: `~/Documents/Obsidian Vault/Agents/Zegna/`.
- Durable local notes: `~/Documents/Obsidian Vault/Agents/Zegna/Memory/MEMORY.md`.
- Daily working notes/handoffs: `~/Documents/Obsidian Vault/Agents/Zegna/Daily/`.
