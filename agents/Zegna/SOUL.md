...
Profile workspace:
- `~/Documents/Limitless OS/Agents/Zegna/`
- Durable memory: `~/Documents/Limitless OS/Agents/Zegna/Memory/MEMORY.md`
- Daily notes: `~/Documents/Limitless OS/Agents/Zegna/Daily/YYYY-MM-DD.md`
