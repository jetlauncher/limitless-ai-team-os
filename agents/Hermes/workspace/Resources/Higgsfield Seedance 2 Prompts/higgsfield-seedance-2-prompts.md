# Higgsfield Seedance 2.0 — Extracted Prompt Library

Source: https://higgsfield.ai/blog/guide-animation-seedance2.0?utm_source=yt&utm_medium=video&utm_category=prd&utm_campaign=Seedance+2.0&utm_creator=higgsfieldai&utm_content_type=de&utm_post=PYAcMw&invite_code=seedance-2-0-higgsfieldai-PYAcMw
Title: AI Short Film – Full Prompt Library: Seedance 2.0
Extracted prompts: 18

## 1. Scene 1 — The Bedroom (Anime / Paper Cutout Style) — Generation 1 — Character keyframe

**What it does:** Generates your hero character and establishes the base visual style for the whole film.
...
## 2. Scene 1 — The Bedroom (Anime / Paper Cutout Style) — Generation 2 — Watch prop sheet

**What it does:** Creates a multi-angle prop sheet for the watch. This is the recurring object in every scene — multiple orthographic views keep it consistent across all 8 styles.
...
## 3. Scene 1 — The Bedroom (Anime / Paper Cutout Style) — Generation 3 — Animated scene

**What it does:** Animates the full opening scene. He wakes up late, sees a message from Anna, rushes to get ready, discovers the hidden ULTRAFAST route on his watch, and teleports out.
...
## 4. Scene 2 — The Cowboy Chase (2D Graphic Novel / Moebius Style) — Generation 1 — Character keyframe

**What it does:** Generates the keyframe for the cowboy chase and establishes the French graphic novel visual style.
...
## 5. Scene 2 — The Cowboy Chase (2D Graphic Novel / Moebius Style) — Generation 2 — Animated scene

**What it does:** Animates the full chase. He drops from a portal onto a galloping horse in a futuristic city, the cowboy fires and grazes his shoulder, he hits the watch and teleports out. The previous scene's video feeds in as context to keep the story consistent.
...
## 6. Scene 3 — The Chibi Arena (Low-Poly 3D) — Generation 1 — Arena keyframe

**What it does:** Generates the low-poly colosseum environment and establishes the chibi visual style.
...
## 7. Scene 3 — The Chibi Arena (Low-Poly 3D) — Generation 2 — Character edit

**What it does:** Fixes the hero character in the keyframe — swaps hair color to brown and puts him in a black suit to match the character from Scene 1. No new generation needed.
...
## 8. Scene 3 — The Chibi Arena (Low-Poly 3D) — Generation 3 — Animated scene

**What it does:** Animates the full arena sequence. He lands in chibi form, can't control his blocky hands, dodges knights, misses the watch three times, catches it on the fourth try with the edge of his finger, and teleports out.
...
## 9. Scene 4 — The Cyberpunk Rooftop (3D Claymation / Slow-Motion) — Generation 1 — Keyframe

**What it does:** Generates the claymation cyberpunk rooftop keyframe and visual style.
...
## 10. Scene 4 — The Cyberpunk Rooftop (3D Claymation / Slow-Motion) — Generation 2 — Animated scene

**What it does:** Animates the full slow-motion rooftop sequence. Everything moves in deep slow-motion. An android fires from a helicopter, the bullet drifts toward his face for four full seconds, he misses the watch once, presses it with one centimeter to spare.
...
## 11. Scene 5 — The Manga World (1980s–90s Black & White Seinen) — Generation 1 — Manga character sheet

**What it does:** Generates the hero in full manga form before touching Seedance. Thick ink outlines, screentone dots, Akira/Ghost in the Shell density. This is the reference image that goes into Seedance for this scene.
...
## 12. Scene 5 — The Manga World (1980s–90s Black & White Seinen) — Generation 2 — Animated scene

**What it does:** Animates the full manga sequence. He lands in a Japanese courtyard, two samurai attack from both sides, he dodges, runs, climbs a bamboo stalk, frantically jabs the watch face from above, and teleports out. Seedance generates speech bubbles with question marks and kanji sound effects automatically.
...
## 13. Scene 6 — Clay Hell (3D Claymation) — Generation 1 — Keyframe

**What it does:** Generates the claymation hell environment and demon character.
...
## 14. Scene 6 — Clay Hell (3D Claymation) — Generation 2 — Animated scene

**What it does:** Animates the full clay hell sequence. The demon lowers him into the cauldron, his clay feet start melting, his finger sinks through his own melting wrist on the first attempt, he gets the click on the second try, and teleports out — leaving the demon with a sad clay pout.
...
## 15. Scene 7 — The Wedding Crash (2D Cartoon in Live Action) — Generation 1 — Wedding keyframe

**What it does:** Generates the live-action wedding keyframe with a 2D cartoon character already composited in.
...
## 16. Scene 7 — The Wedding Crash (2D Cartoon in Live Action) — Generation 2 — Character swap

**What it does:** Swaps the cartoon character in the keyframe to match our hero from Scene 1 — dark brown messy hair, wide shocked expression, anxious face.
...
## 17. Scene 7 — The Wedding Crash (2D Cartoon in Live Action) — Generation 3 — Animated scene

**What it does:** Animates the full wedding crash. He drops between the bride and groom at the exact moment they're about to kiss. A 2D cartoon inserted into a photorealistic live-action wedding. He stands there awkwardly, hits the watch, vanishes — and the couple slowly lean back toward each other.
...
## 18. Scene 8 — The Restaurant Ending (Live-Action Cinematic) — Generation 1 — Animated scene

**What it does:** The final scene. No Soul Cinema keyframe — just the watch prop sheet, the Scene 1 video, and a text description. He lands in a restaurant bathroom completely wrecked, checks the watch at exactly 18:00, walks out and sits down. Anna walks in — equally destroyed. They laugh. They take off their watches. Anna was never visually described anywhere in the film — Seedance invented her completely.
